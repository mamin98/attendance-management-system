...
public class AttendanceRequestService(
    ...
    IBackgroundJobClient backgroundJobClient) : IAttendanceRequestService
{
    ...
    public async Task ApproveAsync(Guid id)
    {
        ...
        _backgroundJobClient.Enqueue<IAttendanceEmailJob>(x => x.SendRequestStatusEmailAsync(id, "Approved"));
    }
    ...
    public async Task RejectAsync(Guid id)
    {
        ...
        _backgroundJobClient.Enqueue<IAttendanceEmailJob>(x => x.SendRequestStatusEmailAsync(id, "Rejected"));
    }
